...
lint:
	docker pull --platform linux/amd64 oxsecurity/megalinter-go:v9.6.0
	docker run --rm --platform linux/amd64 -v '$(CURDIR):/tmp/lint:rw' oxsecurity/megalinter-go:v9.6.0
